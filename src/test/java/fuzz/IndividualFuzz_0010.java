...
/**
 * Target: org.example.ExtendedVulnerableTest.emptyStringSplit
...
public class IndividualFuzz_0010 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("emptyStringSplit", paramTypes);
      ...
      String methodName = "org.example.ExtendedVulnerableTest.emptyStringSplit";
      ...
      System.err.println("Method not found: emptyStringSplit");
