...
/**
 * Target: org.example.ExtendedVulnerableTest.fileNotFound
...
public class IndividualFuzz_0026 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("fileNotFound", paramTypes);
      ...
      String methodName = "org.example.ExtendedVulnerableTest.fileNotFound";
      ...
      System.err.println("Method not found: fileNotFound");
