...
public class IndividualFuzz_0160 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("stripEnd", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.stripEnd";
      ...
      System.err.println("Method not found: stripEnd");
