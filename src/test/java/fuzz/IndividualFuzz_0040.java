...
/**
 * Target: org.example.VulnerableTest.testAssertion
...
public class IndividualFuzz_0040 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("testAssertion", paramTypes);
      ...
      String methodName = "org.example.VulnerableTest.testAssertion";
      ...
      System.err.println("Method not found: testAssertion");
