...
/**
 * Target: org.apache.commons.lang3.StringUtils.rightPad
 * Params: [java.lang.String, int, char]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0136 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      Class<?>[] paramTypes = new Class<?>[] {String.class, int.class, char.class};
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("rightPad", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.rightPad";
      ...
      System.err.println("Method not found: rightPad");
