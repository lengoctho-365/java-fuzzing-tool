...
public class IndividualFuzz_0042 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("equalsIgnoreCase", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.equalsIgnoreCase";
      ...
      System.err.println("Method not found: equalsIgnoreCase");
