...
/**
 * Target: org.apache.commons.lang3.StringUtils.indexOfAnyBut
 * Params: [java.lang.CharSequence, char]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0057 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      Class<?>[] paramTypes = new Class<?>[] {CharSequence.class, char.class};
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("indexOfAnyBut", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.indexOfAnyBut";
      ...
      System.err.println("Method not found: indexOfAnyBut");
