...
public class IndividualFuzz_0130 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("replaceOnceIgnoreCase", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.replaceOnceIgnoreCase";
      ...
      System.err.println("Method not found: replaceOnceIgnoreCase");
