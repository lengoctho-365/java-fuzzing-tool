...
/**
 * Target: org.apache.commons.lang3.StringUtils.contains
 * Params: [java.lang.CharSequence, int]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0019 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("contains", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.contains";
      ...
      System.err.println("Method not found: contains");
