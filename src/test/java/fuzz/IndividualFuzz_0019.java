...
/**
 * Target: org.example.ExtendedVulnerableTest.assertionFail
 * Params: [boolean]
 */
public class IndividualFuzz_0019 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      args[0] = data.consumeBoolean();

      // Invoke method
      Method m = cls.getDeclaredMethod("assertionFail", paramTypes);
      ...
      String methodName = "org.example.ExtendedVulnerableTest.assertionFail";
      ...
      System.err.println("Method not found: assertionFail");
