...
public class IndividualFuzz_0123 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("replaceAll", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.replaceAll";
      ...
      System.err.println("Method not found: replaceAll");
