...
/**
 * Target: org.apache.commons.lang3.StringUtils.isAnyBlank
 * Params: [java.lang.CharSequence]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0071 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("isAnyBlank", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.isAnyBlank";
      ...
      System.err.println("Method not found: isAnyBlank");
