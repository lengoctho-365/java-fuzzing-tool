...
public class IndividualFuzz_0131 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("replacePattern", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.replacePattern";
      ...
      System.err.println("Method not found: replacePattern");
