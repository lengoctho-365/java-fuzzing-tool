...
/**
 * Target: org.apache.commons.lang3.StringUtils.mid
 * Params: [java.lang.String, int, int]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0101 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("mid", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.mid";
      ...
      System.err.println("Method not found: mid");
