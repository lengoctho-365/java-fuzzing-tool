...
/**
 * Target: org.apache.commons.lang3.StringUtils.isNumericSpace
 * Params: [java.lang.CharSequence]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0082 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("isNumericSpace", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.isNumericSpace";
      ...
      System.err.println("Method not found: isNumericSpace");
