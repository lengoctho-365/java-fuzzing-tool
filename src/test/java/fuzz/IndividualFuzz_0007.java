...
/**
 * Target: org.example.ExtendedVulnerableTest.nullPointerInLoop
 * Params: [java.lang.String]
 */
public class IndividualFuzz_0007 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("nullPointerInLoop", paramTypes);
      ...
      String methodName = "org.example.ExtendedVulnerableTest.nullPointerInLoop";
      ...
      System.err.println("Method not found: nullPointerInLoop");
