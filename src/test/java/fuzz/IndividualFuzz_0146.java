...
/**
 * Target: org.apache.commons.lang3.StringUtils.splitByWholeSeparator
 * Params: [java.lang.String, java.lang.String, int]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0146 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("splitByWholeSeparator", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.splitByWholeSeparator";
      ...
      System.err.println("Method not found: splitByWholeSeparator");
