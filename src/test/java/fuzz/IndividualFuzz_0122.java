...
public class IndividualFuzz_0122 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("replace", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.replace";
      ...
      System.err.println("Method not found: replace");
