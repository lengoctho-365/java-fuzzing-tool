...
public class IndividualFuzz_0161 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("stripStart", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.stripStart";
      ...
      System.err.println("Method not found: stripStart");
