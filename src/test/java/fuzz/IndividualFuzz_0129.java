...
public class IndividualFuzz_0129 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("replaceOnce", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.replaceOnce";
      ...
      System.err.println("Method not found: replaceOnce");
