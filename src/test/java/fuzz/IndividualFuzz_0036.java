...
/**
 * Target: org.example.VulnerableTest.testArrayBounds
 * Params: [java.lang.String]
 */
public class IndividualFuzz_0036 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("testArrayBounds", paramTypes);
      ...
      String methodName = "org.example.VulnerableTest.testArrayBounds";
      ...
      System.err.println("Method not found: testArrayBounds");
