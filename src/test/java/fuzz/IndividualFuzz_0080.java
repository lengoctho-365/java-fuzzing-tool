...
/**
 * Target: org.apache.commons.lang3.StringUtils.isNotEmpty
 * Params: [java.lang.CharSequence]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0080 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("isNotEmpty", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.isNotEmpty";
      ...
      System.err.println("Method not found: isNotEmpty");
