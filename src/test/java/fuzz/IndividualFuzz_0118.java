...
/**
 * Target: org.apache.commons.lang3.StringUtils.repeat
 * Params: [char, int]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0118 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      Class<?>[] paramTypes = new Class<?>[] {char.class, int.class};

      // Generate arguments (including collections)
      Object[] args = new Object[2];
      args[0] = (char)data.consumeInt();
      args[1] = data.consumeInt();

      // Invoke method
      Method m = cls.getDeclaredMethod("repeat", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.repeat";
      ...
      System.err.println("Method not found: repeat");
