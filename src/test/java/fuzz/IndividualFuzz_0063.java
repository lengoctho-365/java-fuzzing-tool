...
/**
 * Target: org.apache.commons.lang3.StringUtils.isAllBlank
 * Params: [java.lang.CharSequence]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0063 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("isAllBlank", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.isAllBlank";
      ...
      System.err.println("Method not found: isAllBlank");
