...
public class IndividualFuzz_0157 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("strip", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.strip";
      ...
      System.err.println("Method not found: strip");
