...
/**
 * Target: org.apache.commons.lang3.StringUtils.leftPad
 * Params: [java.lang.String, int, char]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0097 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("leftPad", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.leftPad";
      ...
      System.err.println("Method not found: leftPad");
