...
/**
 * Target: org.apache.commons.lang3.StringUtils.containsOnly
 * Params: [java.lang.CharSequence, char]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0027 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("containsOnly", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.containsOnly";
      ...
      System.err.println("Method not found: containsOnly");
