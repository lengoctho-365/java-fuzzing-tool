...
/**
 * Target: org.example.ExtendedVulnerableTest.readInvalidFile
...
public class IndividualFuzz_0027 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("readInvalidFile", paramTypes);
      ...
      String methodName = "org.example.ExtendedVulnerableTest.readInvalidFile";
      ...
      System.err.println("Method not found: readInvalidFile");
