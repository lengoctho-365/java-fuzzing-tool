...
/**
 * Target: org.apache.commons.lang3.StringUtils.substringAfter
 * Params: [java.lang.String, int]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0166 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("substringAfter", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.substringAfter";
      ...
      System.err.println("Method not found: substringAfter");
