...
/**
 * Target: org.example.ExtendedVulnerableTest.numberCastError
 * Params: [Object]
 */
public class IndividualFuzz_0022 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("numberCastError", paramTypes);
      ...
      String methodName = "org.example.ExtendedVulnerableTest.numberCastError";
      ...
      System.err.println("Method not found: numberCastError");
