...
public class IndividualFuzz_0105 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("prependIfMissing", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.prependIfMissing";
      ...
      System.err.println("Method not found: prependIfMissing");
