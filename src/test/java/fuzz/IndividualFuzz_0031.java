...
/**
 * Target: org.example.ExtendedVulnerableTest.logZero
 * Params: [double]
 */
public class IndividualFuzz_0031 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("logZero", paramTypes);
      ...
      String methodName = "org.example.ExtendedVulnerableTest.logZero";
      ...
      System.err.println("Method not found: logZero");
