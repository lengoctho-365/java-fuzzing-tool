...
/**
 * Target: org.apache.commons.lang3.StringUtils.joinWith
 * Params: [java.lang.String, Object]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0086 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      args[1] = null; // Unsupported: Object

      // Invoke method
      Method m = cls.getDeclaredMethod("joinWith", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.joinWith";
      ...
      System.err.println("Method not found: joinWith");
