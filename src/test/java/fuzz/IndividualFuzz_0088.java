...
public class IndividualFuzz_0088 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("lastIndexOf", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.lastIndexOf";
      ...
      System.err.println("Method not found: lastIndexOf");
