...
/**
 * Target: org.example.ExtendedVulnerableTest.complexCondition
 * Params: [java.lang.String, int]
 */
public class IndividualFuzz_0033 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("complexCondition", paramTypes);
      ...
      String methodName = "org.example.ExtendedVulnerableTest.complexCondition";
      ...
      System.err.println("Method not found: complexCondition");
