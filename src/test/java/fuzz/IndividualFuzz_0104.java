...
public class IndividualFuzz_0104 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("overlay", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.overlay";
      ...
      System.err.println("Method not found: overlay");
