...
/**
 * Target: org.apache.commons.lang3.StringUtils.trimToEmpty
 * Params: [java.lang.String]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0182 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("trimToEmpty", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.trimToEmpty";
      ...
      System.err.println("Method not found: trimToEmpty");
