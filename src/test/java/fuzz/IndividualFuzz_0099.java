...
/**
 * Target: org.apache.commons.lang3.StringUtils.length
 * Params: [java.lang.CharSequence]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0099 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("length", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.length";
      ...
      System.err.println("Method not found: length");
