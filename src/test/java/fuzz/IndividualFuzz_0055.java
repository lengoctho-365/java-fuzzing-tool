...
/**
 * Target: org.apache.commons.lang3.StringUtils.indexOfAny
 * Params: [java.lang.CharSequence, int, char]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0055 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      Class<?>[] paramTypes = new Class<?>[] {CharSequence.class, int.class, char.class};

      // Generate arguments (including collections)
      Object[] args = new Object[3];
      args[0] = data.consumeString(1024);
      args[1] = data.consumeInt();
      args[2] = (char)data.consumeInt();

      // Invoke method
      Method m = cls.getDeclaredMethod("indexOfAny", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.indexOfAny";
      ...
      System.err.println("Method not found: indexOfAny");
