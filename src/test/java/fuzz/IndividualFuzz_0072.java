...
/**
 * Target: org.apache.commons.lang3.StringUtils.isAnyEmpty
 * Params: [java.lang.CharSequence]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0072 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("isAnyEmpty", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.isAnyEmpty";
      ...
      System.err.println("Method not found: isAnyEmpty");
