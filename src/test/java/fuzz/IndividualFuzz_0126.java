...
public class IndividualFuzz_0126 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("replaceFirst", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.replaceFirst";
      ...
      System.err.println("Method not found: replaceFirst");
