...
/**
 * Target: org.apache.commons.lang3.StringUtils.unwrap
 * Params: [java.lang.String, char]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0187 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("unwrap", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.unwrap";
      ...
      System.err.println("Method not found: unwrap");
