...
/**
 * Target: org.example.ExtendedVulnerableTest.nestedConditions
 * Params: [java.lang.String, java.lang.String, int]
 */
public class IndividualFuzz_0034 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("nestedConditions", paramTypes);
      ...
      String methodName = "org.example.ExtendedVulnerableTest.nestedConditions";
      ...
      System.err.println("Method not found: nestedConditions");
