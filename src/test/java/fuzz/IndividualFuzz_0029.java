...
/**
 * Target: org.example.ExtendedVulnerableTest.regexMatchError
...
public class IndividualFuzz_0029 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("regexMatchError", paramTypes);
      ...
      String methodName = "org.example.ExtendedVulnerableTest.regexMatchError";
      ...
      System.err.println("Method not found: regexMatchError");
