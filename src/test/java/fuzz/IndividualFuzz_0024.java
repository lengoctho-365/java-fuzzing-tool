...
/**
 * Target: org.example.ExtendedVulnerableTest.illegalArgumentString
 * Params: [java.lang.String]
 */
public class IndividualFuzz_0024 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("illegalArgumentString", paramTypes);
      ...
      String methodName = "org.example.ExtendedVulnerableTest.illegalArgumentString";
      ...
      System.err.println("Method not found: illegalArgumentString");
