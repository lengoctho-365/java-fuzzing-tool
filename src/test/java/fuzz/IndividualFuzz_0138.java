...
/**
 * Target: org.apache.commons.lang3.StringUtils.rotate
 * Params: [java.lang.String, int]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0138 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("rotate", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.rotate";
      ...
      System.err.println("Method not found: rotate");
