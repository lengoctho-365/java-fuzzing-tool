...
public class IndividualFuzz_0091 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("lastIndexOfAny", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.lastIndexOfAny";
      ...
      System.err.println("Method not found: lastIndexOfAny");
