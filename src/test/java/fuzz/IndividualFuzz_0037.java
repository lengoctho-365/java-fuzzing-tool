...
/**
 * Target: org.example.VulnerableTest.testNullPointer
...
public class IndividualFuzz_0037 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("testNullPointer", paramTypes);
      ...
      String methodName = "org.example.VulnerableTest.testNullPointer";
      ...
      System.err.println("Method not found: testNullPointer");
