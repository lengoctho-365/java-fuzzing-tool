...
public class IndividualFuzz_0037 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("endsWithAny", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.endsWithAny";
      ...
      System.err.println("Method not found: endsWithAny");
