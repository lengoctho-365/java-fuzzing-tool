...
/**
 * Target: org.example.ExtendedVulnerableTest.bufferOverflow
 * Params: [java.lang.String]
 */
public class IndividualFuzz_0032 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("bufferOverflow", paramTypes);
      ...
      String methodName = "org.example.ExtendedVulnerableTest.bufferOverflow";
      ...
      System.err.println("Method not found: bufferOverflow");
