...
/**
 * Target: org.example.ExtendedVulnerableTest.parseDoubleError
 * Params: [java.lang.String]
 */
public class IndividualFuzz_0013 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("parseDoubleError", paramTypes);
      ...
      String methodName = "org.example.ExtendedVulnerableTest.parseDoubleError";
      ...
      System.err.println("Method not found: parseDoubleError");
