...
/**
 * Target: org.example.VulnerableTest.testStringBounds
 * Params: [java.lang.String]
 */
public class IndividualFuzz_0043 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("testStringBounds", paramTypes);
      ...
      String methodName = "org.example.VulnerableTest.testStringBounds";
      ...
      System.err.println("Method not found: testStringBounds");
