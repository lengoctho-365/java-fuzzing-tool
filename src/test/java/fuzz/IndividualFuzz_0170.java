...
/**
 * Target: org.apache.commons.lang3.StringUtils.substringBefore
 * Params: [java.lang.String, int]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0170 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("substringBefore", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.substringBefore";
      ...
      System.err.println("Method not found: substringBefore");
