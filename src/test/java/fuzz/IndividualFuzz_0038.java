...
/**
 * Target: org.example.VulnerableTest.testRecursion
...
public class IndividualFuzz_0038 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("testRecursion", paramTypes);
      ...
      String methodName = "org.example.VulnerableTest.testRecursion";
      ...
      System.err.println("Method not found: testRecursion");
