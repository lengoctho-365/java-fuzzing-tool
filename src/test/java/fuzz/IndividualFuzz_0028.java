...
/**
 * Target: org.example.ExtendedVulnerableTest.regexPatternError
...
public class IndividualFuzz_0028 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("regexPatternError", paramTypes);
      ...
      String methodName = "org.example.ExtendedVulnerableTest.regexPatternError";
      ...
      System.err.println("Method not found: regexPatternError");
