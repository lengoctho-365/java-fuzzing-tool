...
/**
 * Target: org.example.ExtendedVulnerableTest.stringIndexOutOfBounds
 * Params: [java.lang.String]
 */
public class IndividualFuzz_0008 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("stringIndexOutOfBounds", paramTypes);
      ...
      String methodName = "org.example.ExtendedVulnerableTest.stringIndexOutOfBounds";
      ...
      System.err.println("Method not found: stringIndexOutOfBounds");
