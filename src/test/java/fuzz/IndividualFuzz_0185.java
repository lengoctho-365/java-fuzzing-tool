...
/**
 * Target: org.apache.commons.lang3.StringUtils.truncate
 * Params: [java.lang.String, int, int]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0185 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("truncate", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.truncate";
      ...
      System.err.println("Method not found: truncate");
