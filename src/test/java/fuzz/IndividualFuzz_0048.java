...
/**
 * Target: org.apache.commons.lang3.StringUtils.getLevenshteinDistance
 * Params: [java.lang.CharSequence, java.lang.CharSequence, int]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0048 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      Class<?>[] paramTypes = new Class<?>[] {CharSequence.class, CharSequence.class, int.class};

      // Generate arguments (including collections)
      Object[] args = new Object[3];
      args[0] = data.consumeString(1024);
      args[1] = data.consumeString(1024);
      args[2] = data.consumeInt();

      // Invoke method
      Method m = cls.getDeclaredMethod("getLevenshteinDistance", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.getLevenshteinDistance";
      ...
      System.err.println("Method not found: getLevenshteinDistance");
