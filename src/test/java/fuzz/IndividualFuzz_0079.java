...
/**
 * Target: org.apache.commons.lang3.StringUtils.isNotBlank
 * Params: [java.lang.CharSequence]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0079 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("isNotBlank", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.isNotBlank";
      ...
      System.err.println("Method not found: isNotBlank");
