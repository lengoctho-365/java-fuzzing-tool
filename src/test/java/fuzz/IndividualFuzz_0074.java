...
/**
 * Target: org.apache.commons.lang3.StringUtils.isBlank
 * Params: [java.lang.CharSequence]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0074 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("isBlank", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.isBlank";
      ...
      System.err.println("Method not found: isBlank");
