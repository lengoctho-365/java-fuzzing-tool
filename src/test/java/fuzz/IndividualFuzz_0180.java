...
/**
 * Target: org.apache.commons.lang3.StringUtils.toString
 * Params: [byte[], java.lang.String]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0180 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("toString", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.toString";
      ...
      System.err.println("Method not found: toString");
