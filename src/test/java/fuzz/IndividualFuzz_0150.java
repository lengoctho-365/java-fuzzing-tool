...
/**
 * Target: org.apache.commons.lang3.StringUtils.splitPreserveAllTokens
 * Params: [java.lang.String, char]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0150 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      Class<?>[] paramTypes = new Class<?>[] {String.class, char.class};
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("splitPreserveAllTokens", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.splitPreserveAllTokens";
      ...
      System.err.println("Method not found: splitPreserveAllTokens");
