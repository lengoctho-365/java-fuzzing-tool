...
/**
 * Target: org.apache.commons.lang3.StringUtils.remove
 * Params: [java.lang.String, char]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0107 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("remove", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.remove";
      ...
      System.err.println("Method not found: remove");
