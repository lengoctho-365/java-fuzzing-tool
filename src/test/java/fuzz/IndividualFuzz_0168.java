...
/**
 * Target: org.apache.commons.lang3.StringUtils.substringAfterLast
 * Params: [java.lang.String, int]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0168 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("substringAfterLast", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.substringAfterLast";
      ...
      System.err.println("Method not found: substringAfterLast");
