...
/**
 * Target: org.example.ExtendedVulnerableTest.sqrtNegative
 * Params: [double]
 */
public class IndividualFuzz_0030 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      args[0] = data.consumeDouble();

      // Invoke method
      Method m = cls.getDeclaredMethod("sqrtNegative", paramTypes);
      ...
      String methodName = "org.example.ExtendedVulnerableTest.sqrtNegative";
      ...
      System.err.println("Method not found: sqrtNegative");
