...
/**
 * Target: org.apache.commons.lang3.StringUtils.replaceIgnoreCase
 * Params: [java.lang.String, java.lang.String, java.lang.String, int]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0128 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      Class<?>[] paramTypes = new Class<?>[] {String.class, String.class, String.class, int.class};
      ...
      args[3] = data.consumeInt();

      // Invoke method
      Method m = cls.getDeclaredMethod("replaceIgnoreCase", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.replaceIgnoreCase";
      ...
      System.err.println("Method not found: replaceIgnoreCase");
