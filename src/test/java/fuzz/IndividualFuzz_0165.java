...
/**
 * Target: org.apache.commons.lang3.StringUtils.substring
 * Params: [java.lang.String, int, int]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0165 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("substring", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.substring";
      ...
      System.err.println("Method not found: substring");
