...
/**
 * Target: org.apache.commons.lang3.StringUtils.abbreviate
 * Params: [java.lang.String, java.lang.String, int, int]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0003 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("abbreviate", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.abbreviate";
      ...
      System.err.println("Method not found: abbreviate");
