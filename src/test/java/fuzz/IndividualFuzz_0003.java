...
/**
 * Target: org.example.ExtendedVulnerableTest.arrayIndexFromString
...
public class IndividualFuzz_0003 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("arrayIndexFromString", paramTypes);
      ...
      String methodName = "org.example.ExtendedVulnerableTest.arrayIndexFromString";
      ...
      System.err.println("Method not found: arrayIndexFromString");
