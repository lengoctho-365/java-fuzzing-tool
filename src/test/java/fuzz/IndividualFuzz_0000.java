...
/**
 * Target: org.example.ExtendedVulnerableTest.divisionByZero
 * Params: [int]
 */
public class IndividualFuzz_0000 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("divisionByZero", paramTypes);
      ...
      String methodName = "org.example.ExtendedVulnerableTest.divisionByZero";
      ...
      System.err.println("Method not found: divisionByZero");
