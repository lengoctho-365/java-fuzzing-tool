...
/**
 * Target: org.example.ExtendedVulnerableTest.multipleChecks
 * Params: [java.lang.String]
 */
public class IndividualFuzz_0035 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("multipleChecks", paramTypes);
      ...
      String methodName = "org.example.ExtendedVulnerableTest.multipleChecks";
      ...
      System.err.println("Method not found: multipleChecks");
