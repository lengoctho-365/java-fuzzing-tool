...
public class IndividualFuzz_0005 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("appendIfMissing", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.appendIfMissing";
      ...
      System.err.println("Method not found: appendIfMissing");
