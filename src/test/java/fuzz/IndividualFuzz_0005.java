...
/**
 * Target: org.example.ExtendedVulnerableTest.nullPointerBasic
...
public class IndividualFuzz_0005 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("nullPointerBasic", paramTypes);
      ...
      String methodName = "org.example.ExtendedVulnerableTest.nullPointerBasic";
      ...
      System.err.println("Method not found: nullPointerBasic");
