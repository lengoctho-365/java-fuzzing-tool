...
/**
 * Target: org.apache.commons.lang3.StringUtils.toRootUpperCase
 * Params: [java.lang.String]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0179 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("toRootUpperCase", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.toRootUpperCase";
      ...
      System.err.println("Method not found: toRootUpperCase");
