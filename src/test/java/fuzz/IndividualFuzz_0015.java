...
/**
 * Target: org.apache.commons.lang3.StringUtils.compare
...
public class IndividualFuzz_0015 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      args[2] = data.consumeBoolean();

      // Invoke method
      Method m = cls.getDeclaredMethod("compare", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.compare";
      ...
      System.err.println("Method not found: compare");
