...
/**
 * Target: org.example.ExtendedVulnerableTest.emptyListAccess
 * Params: []
 */
public class IndividualFuzz_0015 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("emptyListAccess", paramTypes);
      ...
      String methodName = "org.example.ExtendedVulnerableTest.emptyListAccess";
      ...
      System.err.println("Method not found: emptyListAccess");
