...
/**
 * Target: org.apache.commons.lang3.StringUtils.isAlpha
 * Params: [java.lang.CharSequence]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0067 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("isAlpha", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.isAlpha";
      ...
      System.err.println("Method not found: isAlpha");
