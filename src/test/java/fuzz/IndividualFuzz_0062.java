...
public class IndividualFuzz_0062 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("indexOfIgnoreCase", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.indexOfIgnoreCase";
      ...
      System.err.println("Method not found: indexOfIgnoreCase");
