...
/**
 * Target: org.apache.commons.lang3.StringUtils.isAllLowerCase
 * Params: [java.lang.CharSequence]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0065 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("isAllLowerCase", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.isAllLowerCase";
      ...
      System.err.println("Method not found: isAllLowerCase");
