...
/**
 * Target: org.example.ExtendedVulnerableTest.assertionWithString
 * Params: [java.lang.String]
 */
public class IndividualFuzz_0020 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("assertionWithString", paramTypes);
      ...
      String methodName = "org.example.ExtendedVulnerableTest.assertionWithString";
      ...
      System.err.println("Method not found: assertionWithString");
