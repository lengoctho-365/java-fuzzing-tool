...
/**
 * Target: org.apache.commons.lang3.StringUtils.replaceChars
 * Params: [java.lang.String, char, char]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0124 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      Class<?>[] paramTypes = new Class<?>[] {String.class, char.class, char.class};

      // Generate arguments (including collections)
      Object[] args = new Object[3];
      args[0] = data.consumeString(1024);
      args[1] = (char)data.consumeInt();
      args[2] = (char)data.consumeInt();

      // Invoke method
      Method m = cls.getDeclaredMethod("replaceChars", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.replaceChars";
      ...
      System.err.println("Method not found: replaceChars");
