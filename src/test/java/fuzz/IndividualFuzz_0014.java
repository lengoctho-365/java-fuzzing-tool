...
/**
 * Target: org.example.ExtendedVulnerableTest.listIndexError
 * Params: [int]
 */
public class IndividualFuzz_0014 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("listIndexError", paramTypes);
      ...
      String methodName = "org.example.ExtendedVulnerableTest.listIndexError";
      ...
      System.err.println("Method not found: listIndexError");
