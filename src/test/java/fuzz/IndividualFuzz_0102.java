...
/**
 * Target: org.apache.commons.lang3.StringUtils.normalizeSpace
 * Params: [java.lang.String]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0102 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("normalizeSpace", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.normalizeSpace";
      ...
      System.err.println("Method not found: normalizeSpace");
