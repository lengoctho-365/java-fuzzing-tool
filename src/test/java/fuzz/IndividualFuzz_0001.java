...
/**
 * Target: org.example.ExtendedVulnerableTest.moduloByZero
...
public class IndividualFuzz_0001 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("moduloByZero", paramTypes);
      ...
      String methodName = "org.example.ExtendedVulnerableTest.moduloByZero";
      ...
      System.err.println("Method not found: moduloByZero");
