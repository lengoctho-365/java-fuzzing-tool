...
/**
 * Target: org.apache.commons.lang3.StringUtils.getDigits
 * Params: [java.lang.String]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0045 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("getDigits", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.getDigits";
      ...
      System.err.println("Method not found: getDigits");
