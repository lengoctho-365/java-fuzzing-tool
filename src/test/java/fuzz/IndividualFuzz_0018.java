...
/**
 * Target: org.example.ExtendedVulnerableTest.recursionWithString
 * Params: [java.lang.String]
 */
public class IndividualFuzz_0018 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("recursionWithString", paramTypes);
      ...
      String methodName = "org.example.ExtendedVulnerableTest.recursionWithString";
      ...
      System.err.println("Method not found: recursionWithString");
