...
public class IndividualFuzz_0109 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("removeAll", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.removeAll";
      ...
      System.err.println("Method not found: removeAll");
