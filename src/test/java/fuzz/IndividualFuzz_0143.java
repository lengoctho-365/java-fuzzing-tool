...
/**
 * Target: org.apache.commons.lang3.StringUtils.splitByCharacterType
 * Params: [java.lang.String]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0143 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("splitByCharacterType", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.splitByCharacterType";
      ...
      System.err.println("Method not found: splitByCharacterType");
