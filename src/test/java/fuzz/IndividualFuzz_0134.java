...
/**
 * Target: org.apache.commons.lang3.StringUtils.right
 * Params: [java.lang.String, int]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0134 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("right", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.right";
      ...
      System.err.println("Method not found: right");
