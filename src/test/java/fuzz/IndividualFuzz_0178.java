...
/**
 * Target: org.apache.commons.lang3.StringUtils.toRootLowerCase
 * Params: [java.lang.String]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0178 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("toRootLowerCase", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.toRootLowerCase";
      ...
      System.err.println("Method not found: toRootLowerCase");
