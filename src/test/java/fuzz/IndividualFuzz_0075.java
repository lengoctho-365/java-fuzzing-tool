...
/**
 * Target: org.apache.commons.lang3.StringUtils.isEmpty
 * Params: [java.lang.CharSequence]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0075 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("isEmpty", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.isEmpty";
      ...
      System.err.println("Method not found: isEmpty");
