...
/**
 * Target: org.example.ExtendedVulnerableTest.arrayIndexError
 * Params: [int]
 */
public class IndividualFuzz_0002 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("arrayIndexError", paramTypes);
      ...
      String methodName = "org.example.ExtendedVulnerableTest.arrayIndexError";
      ...
      System.err.println("Method not found: arrayIndexError");
