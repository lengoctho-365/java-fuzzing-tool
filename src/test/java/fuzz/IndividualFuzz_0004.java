...
/**
 * Target: org.apache.commons.lang3.StringUtils.abbreviateMiddle
 * Params: [java.lang.String, java.lang.String, int]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0004 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("abbreviateMiddle", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.abbreviateMiddle";
      ...
      System.err.println("Method not found: abbreviateMiddle");
