...
/**
 * Target: org.apache.commons.lang3.StringUtils.left
 * Params: [java.lang.String, int]
 * Enhanced: Supports Collections and Generic Types
 */
public class IndividualFuzz_0095 {
  ...
  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      ...
      // Invoke method
      Method m = cls.getDeclaredMethod("left", paramTypes);
      ...
      String methodName = "org.apache.commons.lang3.StringUtils.left";
      ...
      System.err.println("Method not found: left");
